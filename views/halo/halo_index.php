...
<div class="container">
    ...
    <p class="help-block">Please input new page name in singular (for database table and view/edit action variables) and
        plural (for controller name and view names):</p>
